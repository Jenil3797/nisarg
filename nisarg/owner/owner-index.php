...
<link rel="stylesheet" type="text/css" href="message-style1.css">

<!-- <div class="tab">   
  <button class="tablinks" id="defaultOpen" onmouseover="openCity(event, '')"></button>
</div> -->

<div class="tabcontent">
  <?php
   $sql3="SELECT * FROM msg where own_id='$owner_id' ";
  ...
  if(mysqli_num_rows($query3)>0)
  {
    while($ro= mysqli_fetch_assoc($query3)){
      $t = $ro['t_id'];
      $q1 = mysqli_query($db, "select * from tenant where tenant_id='$t'");
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="zone" required="required">
                                ...
                                <option value="pipalya">pipalya</option>
                                <option value="amit nagar">amit nagar</option>
                                <option value="karelibagh">karelibagh</option>
                                <option value="mandvi gate">Mandvi gatehakali</option>
        ...
        if(mysqli_num_rows($query)>0)
      {
          while($row=mysqli_fetch_assoc($query)){ ?>
                ...
                <td>
                  ...
                  <a class="btn btn-danger" href="delete.php?ID=<?php echo $property_id; ?>">Delete</a>
                  </td>
                </tr>
                </form>
                <?php }} ?>
